  ...
  return(
    <div className="flex flex-col gap-4">
      <div className="flex gap-3 items-center">
        ...
        <div className="flex items-center gap-3 w-72 px-3 py-1.5 border text-sm rounded-lg border-white/10 bg-transparent">
          ...
          <tbody>
           {attendees.map((attendee)=>{
            return (
              ...
              <TableCell>{attendee.createdAt === null ? 'Not checked-in' : dayjs().to(attendee.checkedInAt)}</TableCell>
              <TableCell>
          ...
          <tfoot>
            <tr>
              <td 
               ...
               colSpan={3}>
                {attendees.length}  de {total} itens</td>
              <td 
